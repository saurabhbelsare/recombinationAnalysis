...
######Human
directoryName <- "~/workfiles/recombinationAnalysis/human/MAA/30Indv2/"
prefixSeg <- "MAA_gSAsia_30Indv2.chr"
...
allChrRhoVecNorm_indv1 <- allChrRhoVecNorm 
allChrRhoVecNorm_indv2 <- allChrRhoVecNorm 
plot(allChrRhoVecNorm_indv1[1:100])
points(allChrRhoVecNorm_indv2[1:100],col="red")

plot(allChrRhoVecNorm_indv1[1000:1100])
points(allChrRhoVecNorm_indv2[1000:1100],col="red")
